...
return [
   ...
   'valid_current_date'    => 'The {field} field must contain a valid current date.',
   'date_greater_than'     => 'The {field} field must contain an date greater.',
   'create_valid_role'     => 'The {field} field must contain an role valid.',
